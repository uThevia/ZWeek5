...
import static com.example.zweek5.R.layout.activity_my_rate_grid;

//自定义布局中GridView为自带
public class MyRateGridActivity extends AppCompatActivity implements Runnable{
    private GridView myGridView;
    List<String> initRateList, updateRateList;
    Handler handler;
    Message message;
    private final String TAG = "MyRateGridActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(activity_my_rate_grid);

        myGridView = (GridView) findViewById(R.id.my_rate_list);
        //初始化list数据
        ...
        ListAdapter adapter = new ArrayAdapter<String>(MyRateGridActivity.this,
                android.R.layout.simple_list_item_1,
                initRateList);
        //由于自定义包含列表的布局未继承父类ListActivity就无法继承setListAdapter方法，只能用GridView.setAdapter方法设置adapter
            ...
            public void handleMessage(Message msg) {
                switch(msg.what){
                    case 0:
                        ...
                        ListAdapter adapter = new ArrayAdapter<String>(MyRateGridActivity.this, android.R.layout.simple_expandable_list_item_1, updateRateList); //第一个参数若为this则为handler
                        myGridView.setAdapter(adapter);
                        break;
                }
